...
@class SharedKotlinPair<__covariant A, __covariant B>, SharedGetData<DATA>, SharedCharacter, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedFlowUseCase<__covariant T, __contravariant Params>, SharedKotlinUnit, SharedStatus, SharedGender, SharedGenderFEMALE, SharedGenderGENDERLESS, SharedGenderMALE, SharedGenderUNKNOWN, SharedStatusALIVE, SharedStatusDEAD, SharedStatusUNKNOWN, SharedApiCharactersResponse, SharedKtor_client_coreHttpClient, SharedCharacterRemoteInterfaceImplCompanion, SharedApiCharactersResponseApiCharacter, SharedApiCharactersResponseCompanion, SharedApiCharactersResponseApiCharacterLocation, SharedApiCharactersResponseApiCharacterCompanion, SharedApiCharactersResponseApiCharacterLocationCompanion, SharedKoin_coreKoinApplication, SharedKoin_coreModule, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKtor_client_coreHttpClientEngineConfig, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_eventsEvents, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpSendPipeline, SharedKoin_coreKoinApplicationCompanion, SharedKoin_coreLogger, SharedKoin_coreLevel, SharedKoin_coreKoin, SharedKoin_coreInstanceFactory<T>, SharedKoin_coreScope, SharedKoin_coreParametersHolder, SharedKoin_coreScopeDSL, SharedKoin_coreSingleInstanceFactory<T>, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKtor_client_coreHttpRequestData, SharedKtor_client_coreHttpResponseData, SharedKtor_client_coreProxyConfig, SharedKtor_utilsAttributeKey<T>, SharedKtor_eventsEventDefinition<T>, SharedKtor_utilsPipelinePhase, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_client_coreHttpReceivePipelinePhases, SharedKtor_client_coreHttpResponse, SharedKtor_client_coreHttpRequestPipelinePhases, SharedKtor_client_coreHttpRequestBuilder, SharedKtor_client_coreHttpResponsePipelinePhases, SharedKtor_client_coreHttpResponseContainer, SharedKtor_client_coreHttpClientCall, SharedKtor_client_coreHttpSendPipelinePhases, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKoin_coreLockable, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKoin_coreParametersHolderCompanion, SharedKtor_httpUrl, SharedKtor_httpHttpMethod, SharedKtor_httpOutgoingContent, SharedKtor_httpHttpStatusCode, SharedKtor_utilsGMTDate, SharedKtor_httpHttpProtocolVersion, SharedKtor_httpHeadersBuilder, SharedKtor_client_coreHttpRequestBuilderCompanion, SharedKtor_httpURLBuilder, SharedKtor_utilsTypeInfo, SharedKtor_client_coreHttpClientCallCompanion, SharedKoin_coreScopeRegistryCompanion, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>, SharedKtor_httpUrlCompanion, SharedKtor_httpURLProtocol, SharedKtor_httpHttpMethodCompanion, SharedKtor_httpContentType, SharedKotlinCancellationException, SharedKtor_httpHttpStatusCodeCompanion, SharedKtor_utilsGMTDateCompanion, SharedKtor_utilsWeekDay, SharedKtor_utilsMonth, SharedKtor_httpHttpProtocolVersionCompanion, SharedKtor_ioMemory, SharedKtor_ioChunkBuffer, SharedKotlinByteArray, SharedKtor_ioBuffer, SharedKtor_ioByteReadPacket, SharedKtor_utilsStringValuesBuilderImpl, SharedKtor_httpURLBuilderCompanion, SharedKtor_httpURLProtocolCompanion, SharedKtor_httpHeaderValueParam, SharedKtor_httpHeaderValueWithParametersCompanion, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpContentTypeCompanion, SharedKtor_utilsWeekDayCompanion, SharedKtor_utilsMonthCompanion, SharedKtor_ioMemoryCompanion, SharedKtor_ioBufferCompanion, SharedKtor_ioChunkBufferCompanion, SharedKotlinByteIterator, SharedKtor_ioInputCompanion, SharedKtor_ioInput, SharedKtor_ioByteReadPacketCompanion, SharedKotlinKTypeProjection, SharedKotlinx_coroutines_coreAtomicDesc, SharedKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, SharedKotlinKVariance, SharedKotlinKTypeProjectionCompanion, SharedKotlinx_coroutines_coreAtomicOp<__contravariant T>, SharedKotlinx_coroutines_coreOpDescriptor, SharedKotlinx_coroutines_coreLockFreeLinkedListNode, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>;

@protocol SharedKotlinx_coroutines_coreFlow, SharedCharacterRepository, SharedCharacterRemoteInterface, SharedKotlinx_serialization_coreKSerializer, SharedKotlinSuspendFunction0, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinCoroutineContextKey, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContext, SharedKotlinContinuation, SharedKotlinContinuationInterceptor, SharedKotlinx_coroutines_coreRunnable, SharedKotlinx_coroutines_coreCoroutineScope, SharedKtor_ioCloseable, SharedKtor_client_coreHttpClientEngine, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_utilsAttributes, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKoin_coreQualifier, SharedKotlinFunction, SharedKotlinIterator, SharedKtor_client_coreHttpClientPlugin, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinSuspendFunction2, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinComparable, SharedKoin_coreKoinScopeComponent, SharedKotlinKClass, SharedKotlinLazy, SharedKoin_coreScopeCallback, SharedKtor_httpHeaders, SharedKotlinx_coroutines_coreJob, SharedKtor_httpHttpMessage, SharedKtor_ioByteReadChannel, SharedKtor_httpHttpMessageBuilder, SharedKtor_client_coreHttpRequest, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKoin_coreKoinComponent, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKtor_httpParameters, SharedKotlinMapEntry, SharedKtor_utilsStringValues, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinSequence, SharedKotlinx_coroutines_coreSelectClause0, SharedKtor_ioReadSession, SharedKotlinSuspendFunction1, SharedKotlinAppendable, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpParametersBuilder, SharedKotlinKType, SharedKotlinx_coroutines_coreParentJob, SharedKotlinx_coroutines_coreSelectInstance, SharedKtor_ioObjectPool;
...
__attribute__((swift_name("GetData")))
@interface SharedGetData<DATA> : SharedBase
- (instancetype)initWithData:(DATA _Nullable)data errorTitleAndDesc:(SharedKotlinPair<NSString *, NSString *> * _Nullable)errorTitleAndDesc __attribute__((swift_name("init(data:errorTitleAndDesc:)"))) __attribute__((objc_designated_initializer));
- (DATA _Nullable)component1 __attribute__((swift_name("component1()")));
- (SharedKotlinPair<NSString *, NSString *> * _Nullable)component2 __attribute__((swift_name("component2()")));
- (SharedGetData<DATA> *)doCopyData:(DATA _Nullable)data errorTitleAndDesc:(SharedKotlinPair<NSString *, NSString *> * _Nullable)errorTitleAndDesc __attribute__((swift_name("doCopy(data:errorTitleAndDesc:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) DATA _Nullable data __attribute__((swift_name("data")));
@property (readonly) SharedKotlinPair<NSString *, NSString *> * _Nullable errorTitleAndDesc __attribute__((swift_name("errorTitleAndDesc")));
@end;
...
__attribute__((swift_name("CharacterRepository")))
@protocol SharedCharacterRepository
@required
...
*/
- (void)getCharacterWithCompletionHandler:(void (^)(id<SharedKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getCharacter(completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)updateCharacterCharacter:(SharedCharacter *)character completionHandler:(void (^)(id<SharedKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("updateCharacter(character:completionHandler:)")));
@end;

__attribute__((swift_name("FlowUseCase")))
@interface SharedFlowUseCase<__covariant T, __contravariant Params> : SharedBase
- (instancetype)initWithThreadExecutor:(SharedKotlinx_coroutines_coreCoroutineDispatcher *)threadExecutor __attribute__((swift_name("init(threadExecutor:)"))) __attribute__((objc_designated_initializer));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokeParams:(Params _Nullable)params completionHandler:(void (^)(id<SharedKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(params:completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetCharactersUseCase")))
@interface SharedGetCharactersUseCase : SharedFlowUseCase<NSArray<SharedCharacter *> *, SharedKotlinUnit *>
- (instancetype)initWithRepository:(id<SharedCharacterRepository>)repository backgroundThread:(SharedKotlinx_coroutines_coreCoroutineDispatcher *)backgroundThread __attribute__((swift_name("init(repository:backgroundThread:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithThreadExecutor:(SharedKotlinx_coroutines_coreCoroutineDispatcher *)threadExecutor __attribute__((swift_name("init(threadExecutor:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UpdateCharactersUseCase")))
@interface SharedUpdateCharactersUseCase : SharedFlowUseCase<NSArray<SharedCharacter *> *, SharedCharacter *>
- (instancetype)initWithRepository:(id<SharedCharacterRepository>)repository backgroundThread:(SharedKotlinx_coroutines_coreCoroutineDispatcher *)backgroundThread __attribute__((swift_name("init(repository:backgroundThread:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithThreadExecutor:(SharedKotlinx_coroutines_coreCoroutineDispatcher *)threadExecutor __attribute__((swift_name("init(threadExecutor:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@end;
...
@interface SharedCharacter : SharedBase
- (instancetype)initWithId:(int32_t)id name:(NSString *)name status:(SharedStatus *)status species:(NSString *)species gender:(SharedGender *)gender origin:(NSString *)origin location:(NSString *)location image:(NSString *)image isFavorite:(BOOL)isFavorite __attribute__((swift_name("init(id:name:status:species:gender:origin:location:image:isFavorite:)"))) __attribute__((objc_designated_initializer));
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (SharedStatus *)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (SharedGender *)component5 __attribute__((swift_name("component5()")));
- (NSString *)component6 __attribute__((swift_name("component6()")));
- (NSString *)component7 __attribute__((swift_name("component7()")));
- (NSString *)component8 __attribute__((swift_name("component8()")));
- (BOOL)component9 __attribute__((swift_name("component9()")));
- (SharedCharacter *)doCopyId:(int32_t)id name:(NSString *)name status:(SharedStatus *)status species:(NSString *)species gender:(SharedGender *)gender origin:(NSString *)origin location:(NSString *)location image:(NSString *)image isFavorite:(BOOL)isFavorite __attribute__((swift_name("doCopy(id:name:status:species:gender:origin:location:image:isFavorite:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedGender *gender __attribute__((swift_name("gender")));
...
@property (readonly) SharedStatus *status __attribute__((swift_name("status")));
@end;

__attribute__((swift_name("Gender")))
@interface SharedGender : SharedBase
@property (readonly) NSString *value __attribute__((swift_name("value")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Gender.FEMALE")))
@interface SharedGenderFEMALE : SharedGender
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)fEMALE __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGenderFEMALE *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Gender.GENDERLESS")))
@interface SharedGenderGENDERLESS : SharedGender
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)gENDERLESS __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGenderGENDERLESS *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Gender.MALE")))
@interface SharedGenderMALE : SharedGender
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)mALE __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGenderMALE *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Gender.UNKNOWN")))
@interface SharedGenderUNKNOWN : SharedGender
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)uNKNOWN __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGenderUNKNOWN *shared __attribute__((swift_name("shared")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Status.ALIVE")))
@interface SharedStatusALIVE : SharedStatus
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)aLIVE __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedStatusALIVE *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Status.DEAD")))
@interface SharedStatusDEAD : SharedStatus
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)dEAD __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedStatusDEAD *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Status.UNKNOWN")))
@interface SharedStatusUNKNOWN : SharedStatus
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)uNKNOWN __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedStatusUNKNOWN *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CharacterRepositoryImpl")))
@interface SharedCharacterRepositoryImpl : SharedBase <SharedCharacterRepository>
- (instancetype)initWithRemoteInterface:(id<SharedCharacterRemoteInterface>)remoteInterface __attribute__((swift_name("init(remoteInterface:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((swift_name("CharacterRemoteInterface")))
@protocol SharedCharacterRemoteInterface
@required
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getCharacterWithCompletionHandler:(void (^)(SharedApiCharactersResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getCharacter(completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CharacterRemoteInterfaceImpl")))
@interface SharedCharacterRemoteInterfaceImpl : SharedBase <SharedCharacterRemoteInterface>
...
@property (class, readonly, getter=companion) SharedCharacterRemoteInterfaceImplCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CharacterRemoteInterfaceImpl.Companion")))
@interface SharedCharacterRemoteInterfaceImplCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCharacterRemoteInterfaceImplCompanion *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiCharactersResponse")))
@interface SharedApiCharactersResponse : SharedBase
- (instancetype)initWithResults:(NSArray<SharedApiCharactersResponseApiCharacter *> *)results __attribute__((swift_name("init(results:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedApiCharactersResponseCompanion *companion __attribute__((swift_name("companion")));
- (NSArray<SharedApiCharactersResponseApiCharacter *> *)component1 __attribute__((swift_name("component1()")));
- (SharedApiCharactersResponse *)doCopyResults:(NSArray<SharedApiCharactersResponseApiCharacter *> *)results __attribute__((swift_name("doCopy(results:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedApiCharactersResponseApiCharacter *> *results __attribute__((swift_name("results")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiCharactersResponse.ApiCharacter")))
@interface SharedApiCharactersResponseApiCharacter : SharedBase
- (instancetype)initWithId:(SharedInt * _Nullable)id name:(NSString * _Nullable)name status:(NSString * _Nullable)status species:(NSString * _Nullable)species gender:(NSString * _Nullable)gender origin:(SharedApiCharactersResponseApiCharacterLocation * _Nullable)origin location:(SharedApiCharactersResponseApiCharacterLocation * _Nullable)location image:(NSString * _Nullable)image __attribute__((swift_name("init(id:name:status:species:gender:origin:location:image:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedApiCharactersResponseApiCharacterCompanion *companion __attribute__((swift_name("companion")));
- (SharedInt * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (NSString * _Nullable)component5 __attribute__((swift_name("component5()")));
- (SharedApiCharactersResponseApiCharacterLocation * _Nullable)component6 __attribute__((swift_name("component6()")));
- (SharedApiCharactersResponseApiCharacterLocation * _Nullable)component7 __attribute__((swift_name("component7()")));
- (NSString * _Nullable)component8 __attribute__((swift_name("component8()")));
- (SharedApiCharactersResponseApiCharacter *)doCopyId:(SharedInt * _Nullable)id name:(NSString * _Nullable)name status:(NSString * _Nullable)status species:(NSString * _Nullable)species gender:(NSString * _Nullable)gender origin:(SharedApiCharactersResponseApiCharacterLocation * _Nullable)origin location:(SharedApiCharactersResponseApiCharacterLocation * _Nullable)location image:(NSString * _Nullable)image __attribute__((swift_name("doCopy(id:name:status:species:gender:origin:location:image:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) SharedApiCharactersResponseApiCharacterLocation * _Nullable location __attribute__((swift_name("location")));
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
@property (readonly) SharedApiCharactersResponseApiCharacterLocation * _Nullable origin __attribute__((swift_name("origin")));
@property (readonly) NSString * _Nullable species __attribute__((swift_name("species")));
@property (readonly) NSString * _Nullable status __attribute__((swift_name("status")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiCharactersResponse.ApiCharacterCompanion")))
@interface SharedApiCharactersResponseApiCharacterCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedApiCharactersResponseApiCharacterCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiCharactersResponse.ApiCharacterLocation")))
@interface SharedApiCharactersResponseApiCharacterLocation : SharedBase
...
@property (class, readonly, getter=companion) SharedApiCharactersResponseApiCharacterLocationCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (SharedApiCharactersResponseApiCharacterLocation *)doCopyName:(NSString * _Nullable)name __attribute__((swift_name("doCopy(name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiCharactersResponse.ApiCharacterLocationCompanion")))
@interface SharedApiCharactersResponseApiCharacterLocationCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedApiCharactersResponseApiCharacterLocationCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiCharactersResponse.Companion")))
@interface SharedApiCharactersResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedApiCharactersResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

@interface SharedApiCharactersResponse (Extensions)
- (NSArray<SharedCharacter *> *)toDomain __attribute__((swift_name("toDomain()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InjectionKt")))
@interface SharedInjectionKt : SharedBase
+ (SharedKoin_coreKoinApplication *)doInitKoinListAppModule:(NSArray<SharedKoin_coreModule *> *)listAppModule appDeclaration:(void (^)(SharedKoin_coreKoinApplication *))appDeclaration __attribute__((swift_name("doInitKoin(listAppModule:appDeclaration:)")));
@property (class, readonly) SharedKoin_coreModule *baseModule __attribute__((swift_name("baseModule")));
@property (class, readonly) SharedKoin_coreModule *clientModule __attribute__((swift_name("clientModule")));
@property (class, readonly) SharedKoin_coreModule *remoteModule __attribute__((swift_name("remoteModule")));
@property (class, readonly) SharedKoin_coreModule *repoModule __attribute__((swift_name("repoModule")));
@property (class, readonly) SharedKoin_coreModule *useCaseModule __attribute__((swift_name("useCaseModule")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FlowUseCaseKt")))
@interface SharedFlowUseCaseKt : SharedBase
+ (id<SharedKotlinx_coroutines_coreFlow>)listFlowBlock:(id<SharedKotlinSuspendFunction0>)block __attribute__((swift_name("listFlow(block:)")));
@end;
